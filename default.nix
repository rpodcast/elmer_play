# This file was generated by the {rix} R package v0.12.4 on 2024-10-05
# with following call:
# >rix(r_ver = "frozen_edge",
#  > r_pkgs = NULL,
#  > system_pkgs = NULL,
#  > git_pkgs = list(list(package_name = "elmer",
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/cd9386107b5f93524296dc98cdbf6e6b9913d510.tar.gz") {};
...
pkgs.mkShell {
  ...
  buildInputs = [ git_archive_pkgs rpkgs  system_packages shinychat ];
